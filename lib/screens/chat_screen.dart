...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _messages.add(Message(
      text: "Hi! I'm your Unfold AI assistant. How can I help you with your home today?",
      isUser: false,
    ));
  }
  ...
  void _handleSubmitted(String text) async {
    ...
    setState(() {
      ...
      if (response != null && response.isNotEmpty) {
        ...
        _messages.add(Message(text: "Sorry, I couldn't get a response. Please try again.", isUser: false));
      }
    });
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: IconButton(
              icon: const Icon(Icons.refresh_rounded, color: AppColors.roseDeep),
              onPressed: () {
                setState(() {
                  _messages.clear();
        ...
        children: [
          if (!message.isUser) ...[
            Container(
              ...
              child: CircleAvatar(
                backgroundColor: AppColors.cream,
                child: const Icon(Icons.auto_awesome_rounded, color: AppColors.roseDeep),
              ),
            ),
          ],
          Flexible(
              ...
              child: message.isUser 
                ...
                : MarkdownBody(
                    ...
                    styleSheet: MarkdownStyleSheet(
                      ...
                      listBullet: TextStyle(color: AppColors.rose, fontSize: 16),
                      code: TextStyle(
                        backgroundColor: AppColors.cream,
          ...
          if (message.isUser) ...[
            Container(
              ...
              child: CircleAvatar(
                ...
                child: const Icon(Icons.person_rounded, color: AppColors.roseDeep),
              ),
            ),
          ],
        ],
  ...
  Widget _buildTextComposer() {
    return Container(
      margin: const EdgeInsets.only(left: 16.0, right: 16.0, bottom: 16.0, top: 4.0),
      decoration: BoxDecoration(
        color: Colors.white,
